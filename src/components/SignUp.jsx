  ...
  return (
    <div className= " flex flex-col justify-center w-[90%] mx-auto mb-[40px] font-mono">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <h2 className="mt-6 text-center text-2xl sm:text-3xl text-gray-900">Register With Us</h2>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md w-2vw">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg rounded-lg sm:px-10 border border-black">
          ...
          <div className="mt-6 text-center">
            ...
            <p onClick={() => navigate('/signin')} className="font-medium text-yellow-500 hover:text-yellow-600 cursor-pointer">
              Sign In
            </p>
          </div>
        </div>
